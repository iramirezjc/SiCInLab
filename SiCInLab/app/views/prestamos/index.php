    ...
    <div class="container">
        <form action="<?= Enlace::url('prestamos/guardar') ?>" method="POST" accept-charset="utf-8">
            <div class="mb-3">
        	    ...
        	    <input type="text" class="form-control" id="usuario" name="usuario"  value="5601" readonly/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3" id="devol">
        	    ...
        	    <input type="date" class="form-control" id="devolucion" name="devolucion" value="<?php echo date('Y-m-d'); ?>" autocomplete="off" required>
            </div>
